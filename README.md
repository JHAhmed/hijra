...
<!-- Items that are commented out are completed! -->

<!-- - Add page for pilgrim tracking -->
<!-- - Add sync location option for live tracking -->

<!-- - Increase font size for stats in admin panel -->
<!-- - Add terms and conditions element -->

<!-- - Only display lead pilgrim details in the pilgrim list, and add a view more button to see other pilgrims under the lead pilgrim
- In lead pilgrim details page, add a button to view all pilgrims under the lead pilgrim -->

<!-- - Add option to create batches for pilgrims under a lead pilgrim using date selection - create batches in database -->
<!-- - Create a batch details page to view all pilgrims under that batch, and a link for the guide and members of the batch -->
<!-- - Add option to manually assign a guide to a batch, manually assign pilgrims to a batch -->
<!-- - Add manual update and delete options for batches -->
